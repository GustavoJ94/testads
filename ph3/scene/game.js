...
export default class Game extends Phaser.Scene {
    ...
    resize (gameSize, baseSize, displaySize, resolution){
        ...
        this.logoPhaser.setScale(0.2*window.devicePixelRatio)

        this.text.setScale(0.2*window.devicePixelRatio)
        this.text.setPosition(width / 2, (height/2) - 80)

        this.logoLeftTop.setScale(0.2*window.devicePixelRatio)
        this.logoRightTop.setScale(0.2*window.devicePixelRatio)
        this.logoLeftBottom.setScale(0.2*window.devicePixelRatio)
        this.logoRightBottom.setScale(0.2*window.devicePixelRatio)
