...
export default class Game extends Phaser.Scene {
    ...
    create() {
        ...
        //Proportion
        let bg = this.add.sprite(window.innerWidth / 2, window.innerHeight / 2, 'bg')
        ...
        // logoCenter -------------------------------------------------------------
        let logoCenter = this.add.sprite(window.innerWidth / 2, window.innerHeight / 2, 'logo').setScale(scaleLogo)

        // logoPhaser -------------------------------------------------------------
        let logoPhaser = this.add.sprite(window.innerWidth / 2, window.innerHeight / 2 + window.innerHeight / 4, 'logoPhaser').setScale(scaleLogo).setInteractive()
        ...
        // logoLeftTop -------------------------------------------------------------
        let logoLeftTop = this.add.sprite(0, 0, 'logo').setScale(scaleLogo).setOrigin(0, 0)
        logoLeftTop.update = function () {
            this.setPosition(app.left, app.top)
        }

        // logoRightTop -------------------------------------------------------------
        let logoRightTop = this.add.sprite(0, 0, 'logo').setScale(scaleLogo).setOrigin(1, 0)
        logoRightTop.update = function () {
            this.setPosition(app.right, app.top)
        }

        // logoLeftBottom -------------------------------------------------------------
        let logoLeftBottom = this.add.sprite(0, 0, 'logo').setScale(scaleLogo).setOrigin(0, 1)
        logoLeftBottom.update = function () {
            this.setPosition(app.left, app.bottom)
        }

        // logoRightBottom -------------------------------------------------------------
        let logoRightBottom = this.add.sprite(0, 0, 'logo').setScale(scaleLogo).setOrigin(1, 1)
